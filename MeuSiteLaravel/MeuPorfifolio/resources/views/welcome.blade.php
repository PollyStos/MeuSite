...
<head>
    ...
    <!-- Font-Awesome CSS -->
    <link rel="stylesheet" href="php/font-awesome/css/all.min.css" />

    <!-- Swiper CSS -->
    <link rel="stylesheet" href="php/swiper/swiper.css" />

    <!-- Magnific-Popup CSS -->
    <link rel="stylesheet" href="php/magnific-popup/magnific-popup.css" />
...
<body>
    ...
    <section class="home" id="home">
        ...
        <div class="box-container">
            ...
            <div class="content">
                <div class="text">
                    <h2>Olá</h1>
                    <h1>Eu sou  <span class="typing-text"></span></h1>
                    ...
                    <a href="#" class="btn">Sobre<i class="fas fa-user"></i></a>
                </div>
            </div>
    
            <div class="image">
                <img src="img/Home/polly-img.png" alt="Polly-Home">
            </div>
    ...
    <section class="about" id="about">
        ...
        <!-- <div class="box-container">
            ...
            <div class="image">
                <img src="img/About/About-Polly.png" alt="About-Image" />
            </div>   -->
            <!-- <div class="content">

                <h2>Meu nome é Polyana.</h2>
        ...
        <div class="skill-container">
            ...
            <div class="skills">
                ...
                <div class="skill-item item2">
                    ...
                    <div class="box">
                        <h3>Unit<span> 30% </span> </h3>
                        <div class="progress-bar"> <span></span> </div>
                    </div>
                    <div class="box">
                        <h3>Photoshop/Illustrator<span> 80% </span> </h3>
                        <div class="progress-bar"> <span></span> </div>
                    </div>
                </div>
...
<!-- 
    ...
    <section class="portfolio" id="portfolio">
        ...
        <div class="gallery">
            ...
            <ul class="controls">
                ...
                <li class="button btn" data-filter="web">Desenvolveminto Web</li>
                <li class="button btn" data-filter="design">design de game</li>
                <li class="button btn" data-filter="photography">Edição de Vídeo</li>
            </ul>
    
            <div class="box-container">
    
                <div class="portfolio-item image web">
                    <img src="img/Portfolio/portfolio-1.png" alt="Portfolio-Image" />
                    <div class="content">
                        <h4>Desenvolveminto Web</h4>
                        <p>category</p>
                        <a data-effect="mfp-newspaper" href="img/Portfolio/portfolio-1.png" class="view-btn"><i class="fas fa-search-plus"></i></a>
                    </div>
                </div>
    
                <div class="portfolio-item image web">
                    <img src="img/Portfolio/portfolio-2.png" alt="Portfolio-Image" />
                    <div class="content">
                        <h4>Desenvolveminto Web</h4>
                        <p>category</p>
                        <a data-effect="mfp-newspaper" href="img/Portfolio/portfolio-2.png" class="view-btn"><i class="fas fa-search-plus"></i></a>
                    </div>
                </div>
    
                <div class="portfolio-item image design">
                    <img src="img/Portfolio/portfolio-3.png" alt="Portfolio-Image" />
                    <div class="content">
                        <h4>design de game</h4>
                        <p>category</p>
                        <a data-effect="mfp-newspaper" href="img/Portfolio/portfolio-3.png" class="view-btn"><i class="fas fa-search-plus"></i></a>
                    </div>
                </div>
    
                <div class="portfolio-item image design">
                    <img src="img/Portfolio/portfolio-4.png" alt="Portfolio-Image" />
                    <div class="content">
                        <h4>design de game</h4>
                        <p>category</p>
                        <a data-effect="mfp-newspaper" href="img/Portfolio/portfolio-4.png" class="view-btn"><i class="fas fa-search-plus"></i></a>
                    </div>
                </div>
                <div class="portfolio-item image photography">
                    <img src="img/Portfolio/portfolio-5.png" alt="Portfolio-Image" />
                    <div class="content">
                        <h4>Edição de Vídeo</h4>
                        <p>category</p>
                        <a data-effect="mfp-newspaper" href="img/Portfolio/portfolio-5.png" class="view-btn"><i class="fas fa-search-plus"></i></a>
                    </div>
                </div>
    
                <div class="portfolio-item image photography">
                    <img src="img/Portfolio/portfolio-6.png" alt="Portfolio-Image" />
                    <div class="content">
                        <h4>Edição de Vídeo</h4>
                        <p>category</p>
                        <a data-effect="mfp-newspaper" href="img/Portfolio/portfolio-6.png" class="view-btn"><i class="fas fa-search-plus"></i></a>
                    </div>
                </div>
        ...
        <div class="swiper-container testimonial-slider">
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide testi-item">
                    <img src="img/Testimonials/pic-1.png" alt="Testimonial-Pic" />
                ...
                <div class="swiper-slide testi-item">
                    <img src="img/Testimonials/pic-2.png" alt="Testimonial-Pic" />
                ...
                <div class="swiper-slide testi-item">
                    <img src="img/Testimonials/pic-3.png" alt="Testimonial-Pic" />
                ...
                <div class="swiper-slide testi-item">
                    <img src="img/Testimonials/pic-4.png" alt="Testimonial-Pic" />
                ...
                <div class="swiper-slide testi-item">
                    <img src="img/Testimonials/pic-5.png" alt="Testimonial-Pic" />
        ...
        <div class="swiper-container blog-slider">
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide blog-item">
                    <div class="image">
                        <img src="img/Blogs/blog-1.png" alt="Blog-Image" />
                    </div>
                    <div class="content">
                        <div class="intro">
                ...
                <div class="swiper-slide blog-item">
                    <div class="image">
                        <img src="img/Blogs/blog-2.png" alt="Blog-Image" />
                    </div>
                    <div class="content">
                        <div class="intro">
                            <h5><i class="fas fa-calendar-alt"></i><span>1st jan, 2022</span></h5>
                ...
                <div class="swiper-slide blog-item">
                    <div class="image">
                        <img src="img/Blogs/blog-3.png" alt="Blog-Image" />
                    </div>
                    <div class="content">
                        <div class="intro">
                            <h5><i class="fas fa-calendar-alt"></i><span>1st jan, 2022</span></h5>
                ...
                <div class="swiper-slide blog-item">
                    <div class="image">
                        <img src="img/Blogs/blog-4.png" alt="Blog-Image" />
                    </div>
                    <div class="content">
                        <div class="intro">
                            <h5><i class="fas fa-calendar-alt"></i><span>1st jan, 2022</span></h5>
                ...
                <div class="swiper-slide blog-item">
                    <div class="image">
                        <img src="img/Blogs/blog-5.png" alt="Blog-Image" />
                    </div>
                    <div class="content">
                        <div class="intro">
                            <h5><i class="fas fa-calendar-alt"></i><span>1st jan, 2022</span></h5>
    ...
    <script>
        var typed = new Typed('.typing-text', {
            ...
            strings: ['Polyana Santos','Game Design'],
            typeSpeed: 120,
            loop: true
        });
    </script>
